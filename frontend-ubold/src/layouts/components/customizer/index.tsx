...
const Customizer = () => {
  ...
  return (
    <Offcanvas show={isCustomizerOpen} onHide={toggleCustomizer} placement="end" className="overflow-hidden">
      <div className="d-flex justify-content-between text-bg-primary gap-2 p-3" style={{ backgroundImage: `url(${pattern.src})` }}>
        ...
        <div className="flex-grow-0">
          <button onClick={toggleCustomizer} type="button" className="d-block btn btn-sm bg-white bg-opacity-25 text-white rounded-circle btn-icon">
            <TbX className="fs-lg" />
          </button>
        </div>
      </div>
              ...
              <Col sm={6} key={idx}>
                <div className="form-check card-radio">
                  <input
                    ...
                    onChange={() => updateSettings({ skin: item.skin })}
                  />
              ...
              <Col sm={4} key={idx}>
                <div className="form-check card-radio">
                  <input
                    ...
                    onChange={() => updateSettings({ theme: item.theme })}
                  />
              ...
              <Col sm={4} key={idx}>
                <div className="form-check card-radio">
                  <input
                    ...
                    value={item.color}
                    checked={topBarColor === item.color}
                    onChange={() => updateSettings({ topBarColor: item.color })}
                  />
              ...
              <Col sm={4} key={idx}>
                <div className="form-check card-radio">
                  <input
                    ...
                    onChange={() => updateSettings({ orientation: item.orientation })}
                  />
              ...
              <Col sm={4} key={idx}>
                <div className="form-check card-radio">
                  <input
                    ...
                    value={item.color}
                    checked={sidenavColor === item.color}
                    onChange={() => updateSettings({ sidenavColor: item.color })}
                  />
                  ...
                  <Col sm={4} key={idx}>
                    <div className="form-check card-radio">
                      <input
                        ...
                        value={item.size}
                        checked={sidenavSize === item.size}
                        onChange={() => updateSettings({ sidenavSize: item.size })}
                      />
                  ...
                  {layoutPositionOptions.map((item, idx) => (
                    <Fragment key={idx}>
                      <input
                        ...
                        onChange={() => updateSettings({ position: item.position })}
                      />
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="form-check form-switch fs-lg">
                  <input
                    ...
                    name="sidebar-user"
                    checked={sidenavUser}
                    onChange={() => updateSettings({ sidenavUser: !sidenavUser })}
                  />
                </div>
              </div>
            </div>
      ...
      <div className="offcanvas-footer border-top p-3 text-center">
        <Row>
          ...
          <Col sm={6}>
            <a href={''} target="_blank" className="btn btn-danger bg-gradient py-2 fw-semibold w-100">
              Buy Now
            </a>
          </Col>
        </Row>
