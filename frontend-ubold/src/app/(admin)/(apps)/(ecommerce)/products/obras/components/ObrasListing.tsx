...
const mapStrapiObraToObraType = (obra: any): ObraType => {
  ...
  return {
    ...
    url: `/products/obras/${obra.id || obra.documentId || obra.id}`, // URL para edición
  }
}
      ...
      cell: ({ row }) => {
        return (
          <div className="d-flex">
            ...
            <div>
              <h5 className="mb-0">
                <Link href={`/products/obras/${row.original.id}`} className="link-reset">
    ...
    }),
    {
      ...
      cell: ({ row }: { row: TableRow<ObraType> }) => (
        <div className="d-flex gap-1">
          <Link href={`/products/obras/${row.original.id}`}>
      ...
      <Col xs={12}>
        <Card className="mb-4">
          <CardHeader className="d-flex justify-content-between align-items-center">
            ...
            <div className="d-flex gap-1">
              <Link passHref href="/products/obras">
              ...
              <Link href="/products/obras/agregar" passHref>
