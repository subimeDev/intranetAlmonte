...
import { estimates, EstimateType } from '../data'
            ...
            cell: ({ row }) => (
                <div className="d-flex align-items-center gap-2">
                    <div className="avatar-sm border flex-shrink-0 border-dashed rounded-circle me-2 justify-content-center d-flex align-items-center">
                        <Image src={row.original.client.logo} alt={row.original.client.name} height={20} />
                    </div>
        ...
        columnHelper.accessor('estimatedBy', {
            ...
            , cell: ({ row }) => (
                <div className="d-flex gap-2 align-items-center">
                    <Image src={row.original.estimatedBy.avatar} alt={row.original.estimatedBy.name} height={20} className="avatar-xs rounded-circle" />
