...
import { Card, CardBody, Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, FormControl, FormLabel, Modal, ModalBody, ModalFooter, ModalHeader, Row } from 'react-bootstrap'
                ...
                <CardBody className="d-flex flex-column justify-content-between">
                    ...
                    <div className="avatar-group avatar-group-sm mb-3">
                        <div className="avatar">
                            <Image src={user7} alt='user7' className="rounded-circle avatar-sm" />
                        </div>
                        <div className="avatar">
                            <Image src={user8} alt='user8' className="rounded-circle avatar-sm" />
                        </div>
                        <div className="avatar">
                            <Image src={user9} alt='user9' className="rounded-circle avatar-sm" />
                        </div>
                        <div className="avatar">
                            <Image src={user10} alt='user10' className="rounded-circle avatar-sm" />
                        </div>
                    </div>
